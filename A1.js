  ...
  if (keyboard.pressed("w")) {
    switch (components[selectedRobotComponent]) {
      ...
      case "Head":
        ...
        break;
      case "Larm":
        robot.Larm.rotateArm(0.1, "x", robot.torso, robot.LFarm, robot.Lhand);
        break
      case "Lfarm":
        robot.LFarm.rotateFarm(0.1, "x", robot.torso, robot.Larm, robot.Lhand);
        break
      case "Rarm":
        robot.Rarm.rotateArm(0.1, "x", robot.torso, robot.RFarm, robot.Rhand);
        break
      case "Rfarm":
        robot.RFarm.rotateFarm(0.1, "x", robot.torso, robot.Rarm, robot.Rhand);
        break
      case "Lleg":
        robot.Lleg.rotateArm(0.1, "x", robot.torso, robot.Lfleg, robot.Lfoot);
        break
      case "Rleg":
        robot.Rleg.rotateArm(0.1, "x", robot.torso, robot.Rfleg, robot.Rfoot);
        break
        case "Lfleg":
        robot.Lfleg.rotateFarm(0.1, "x", robot.torso, robot.Lleg, robot.Lfoot);
        break
      case "Rfleg":
        robot.Rfleg.rotateArm(0.1, "x", robot.torso, robot.Rleg, robot.Rfoot);
        break
      case "":
        break
      // Add more cases
